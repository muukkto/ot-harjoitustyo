...
class TestPlanService(unittest.TestCase):
    ...
    def test_add_course_1(self):
        ...
        self.assertCountEqual(self.plan_service.get_course_codes(), ["MAA1"])
    ...
    def test_add_course_2(self):
        ...
        self.assertCountEqual(
            self.plan_service.get_course_codes(), ["PS2", "ENA5"])
    ...
    def test_cannot_add_course_outside_curriculum(self):
        ...
        self.assertCountEqual(
            self.plan_service.get_course_codes(), [])

    def test_add_own_course(self):
        self.login()
        self.plan_service.add_course("OMA1", "Oma kurssi", 3, False)
        self.assertCountEqual(self.plan_service.get_course_codes(), ["OMA1"])
    ...
    def test_cannot_add_own_course_with_cur_code(self):
        ...
        self.assertCountEqual(self.plan_service.get_course_codes(), [])

    def test_delete_course_1(self):
        self.login()
        self.plan_service.add_course("HI4")
        self.assertCountEqual(self.plan_service.get_course_codes(), ["HI4"])
    ...
    def test_delete_course_2(self):
        ...
        self.assertCountEqual(
            self.plan_service.get_course_codes(), ["S27", "UR1"])
        self.plan_service.delete_course("UR1")
        self.assertCountEqual(self.plan_service.get_course_codes(), ["S27"])
